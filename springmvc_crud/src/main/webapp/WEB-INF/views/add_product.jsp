...
<div class="col-md-6 offset-md-3" >
 <div class="card-body py-5 bg-danger" >
    <form action="addpro" class="mt-3" method="post" >
    ...
    <input class="form-control" type="text" name="description" placeholder="Enter your product description"/>
    </div>
    <div class="form-group">
    <label class="text-white">Product Price</label>
    <input class="form-control" type="text" name="price" placeholder="Enter your product description"/>
    </div>
